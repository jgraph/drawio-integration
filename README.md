...
* <a href="http://jgraph.github.io/drawio-integration/javascript.html" target="_blank">JavaScript API</a> for editing embedded SVG and PNG images in a HTML page (see <a href="https://github.com/jgraph/drawio-integration/blob/master/diagram-editor.js" target="_blank">code</a>)
